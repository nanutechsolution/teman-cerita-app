<x-layouts.app :settings="$settings ?? null">
    ...
    <div x-data="{ showModal: false, activeVideo: null }" class="min-h-screen bg-black py-12 sm:py-16 relative overflow-hidden">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
                    @foreach($videos as $video)
                        ...
                        <a href="{{ route('post.show', $video->slug) }}" 
                           ...
                           @endif
                           class="group flex flex-col gap-4 rounded-2xl hover:bg-white/[0.02] p-3 -m-3 transition-all duration-300 border border-transparent hover:border-neutral-800 cursor-pointer">
