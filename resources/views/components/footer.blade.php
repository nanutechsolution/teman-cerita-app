        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16 mb-16">
            ...
            <div class="lg:col-span-4 space-y-6">
                <a href="/" class="group inline-flex items-center gap-4">
                    <div class="relative w-12 h-12 bg-neutral-100 dark:bg-[#1a1a1a] rounded-full flex items-center justify-center border border-neutral-200 dark:border-neutral-800 group-hover:border-red-600 dark:group-hover:border-red-600 transition-colors">
                        @if(isset($settings['site_logo']))
                            <img src="{{ asset('storage/' . $settings['site_logo']) }}" alt="Logo" class="w-full h-full object-cover rounded-full">
                        @else
                            <svg class="w-6 h-6 text-neutral-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3.75m-3.75 0h7.5M12 15.75a3 3 0 01-3-3V4.5a3 3 0 116 0v8.25a3 3 0 01-3 3z" />
                            </svg>
                            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 border-t-2 border-red-600 rounded-full opacity-80"></div>
                        @endif
                    </div>
                    <div class="flex flex-col">
                        <span class="text-2xl font-black text-neutral-900 dark:text-white leading-none tracking-tight">
                            Teman<span class="text-red-600">Cerita</span>
                        </span>
                        <span class="text-[10px] font-bold text-neutral-500 dark:text-neutral-400 tracking-[0.2em] uppercase mt-1">
                            Portal Berita NTT
                        </span>
                    </div>
                </a>
                ...
                <div class="inline-flex items-center gap-2 px-3 py-1.5 bg-neutral-100 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-md transition-colors">
                    <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10zm-2.5-6.5l-3-3 1.41-1.41L10 12.67l6.59-6.59L18 7.5l-8.5 8.5z"/></svg>
                ...
                <div class="space-y-3 pt-2">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <a href="/rss" target="_blank" class="w-10 h-10 rounded-full bg-neutral-100 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 flex items-center justify-center text-neutral-600 dark:text-neutral-400 hover:bg-orange-500 hover:text-white dark:hover:text-white hover:border-transparent transition-all" title="RSS Feed">
                            <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M4 11a9 9 0 0 1 9 9H9c0-2.76-2.24-5-5-5v-4zm0-7a16 16 0 0 1 16 16h-4a12 12 0 0 0-12-12V4zm2 14a2 2 0 1 1-4 0 2 2 0 0 1 4 0z"/></svg>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-neutral-50 dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 p-6 rounded-xl transition-colors duration-300">
                    ...
                    <form action="#" class="flex gap-2">
                        ...
                        <button type="submit" class="bg-red-600 text-white px-5 rounded-md hover:bg-red-700 transition-colors flex items-center justify-center">
                            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                        </button>
                    </form>
                </div>
        ...
        <div class="pt-8 border-t border-neutral-200 dark:border-neutral-800 flex flex-col lg:flex-row justify-between items-center gap-6 text-center lg:text-left transition-colors duration-300">
            <div class="flex flex-col gap-1">
                <div class="text-neutral-900 dark:text-neutral-300 text-sm font-semibold transition-colors">
                    {{ $settings['footer_text'] ?? '© ' . date('Y') . ' Teman Cerita NTT. Seluruh Hak Cipta Dilindungi.' }}
                </div>
