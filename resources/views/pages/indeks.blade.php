...
<x-layouts.app :settings="$settings">
    ...
    <style>
        ...
        .custom-pagination nav span[aria-current="page"] span { @apply bg-red-600 border-red-600 text-white font-black; }
        .custom-pagination nav a { @apply font-black text-neutral-500 dark:text-neutral-400 transition-colors hover:text-red-600 dark:hover:text-red-500; }
    </style>
</x-layouts.app>