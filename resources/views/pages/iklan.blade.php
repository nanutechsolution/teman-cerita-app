    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 pt-24 lg:pt-32 pb-20">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="group p-10 bg-white dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-[2.5rem] hover:border-red-600 transition-all shadow-sm">
                <div class="mb-8">
                    <div class="w-12 h-12 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center text-neutral-500 mb-6"><svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path d="M4 6h16M4 12h16m-7 6h7"/></svg></div>
                    <h3 class="text-2xl font-black text-neutral-900 dark:text-white uppercase italic tracking-tighter mb-4">Display Ads</h3>
                    <p class="text-xs text-neutral-500 leading-relaxed font-bold uppercase tracking-wider">Penempatan Banner di halaman depan, artikel, dan sidebar untuk brand awareness maksimal.</p>
                </div>
                <div class="pt-8 border-t border-neutral-100 dark:border-neutral-800">
                    <span class="text-[10px] font-black text-red-600 uppercase tracking-widest">Mulai dari Rp 500rb/bln</span>
                </div>
            </div>
            ...
            <div class="group p-10 bg-neutral-900 text-white rounded-[2.5rem] border border-neutral-800 transition-all shadow-2xl relative overflow-hidden">
                ...
                <div class="mb-8 relative z-10">
                    <div class="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-red-500 mb-6"><svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div>
                    <h3 class="text-2xl font-black text-white uppercase italic tracking-tighter mb-4">Video Native</h3>
                    <p class="text-xs text-neutral-400 leading-relaxed font-bold uppercase tracking-wider">Integrasi brand ke dalam konten Podcast atau Video Shorts yang agresif di Media Sosial.</p>
                </div>
                <div class="pt-8 border-t border-white/5 relative z-10">
                    <span class="text-[10px] font-black text-red-500 uppercase tracking-widest">Paket Produksi Tersedia</span>
                </div>
            </div>
            ...
            <div class="group p-10 bg-white dark:bg-[#121212] border border-neutral-200 dark:border-neutral-800 rounded-[2.5rem] hover:border-red-600 transition-all shadow-sm">
                <div class="mb-8">
                    <div class="w-12 h-12 rounded-full bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center text-neutral-500 mb-6"><svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></div>
                    <h3 class="text-2xl font-black text-neutral-900 dark:text-white uppercase italic tracking-tighter mb-4">Advertorial</h3>
                    <p class="text-xs text-neutral-500 leading-relaxed font-bold uppercase tracking-wider">Penulisan artikel berbayar yang dikemas secara jurnalistik untuk mempromosikan layanan Anda.</p>
                </div>
                <div class="pt-8 border-t border-neutral-100 dark:border-neutral-800">
                    <span class="text-[10px] font-black text-red-600 uppercase tracking-widest">Free Social Share</span>
                </div>
            </div>
        </div>
