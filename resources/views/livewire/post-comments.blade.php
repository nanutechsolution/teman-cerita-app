<div>
    ...
    <form wire:submit.prevent="save" class="space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {{-- Input Email --}}
            <div>
                <input type="email" wire:model="email" placeholder="Alamat Email" required 
                    class="w-full bg-white dark:bg-[#0c0c0c] border border-neutral-200 dark:border-neutral-800 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-red-600/20 focus:border-red-600 outline-none transition-all dark:text-white">
        ...
        {{-- Isi Komentar --}}
        <div>
            <textarea wire:model="body" rows="4" placeholder="Tulis komentar Anda..." required
        ...
        <button type="submit"
            ...
            <span wire:loading.flex>Mengirim...</span>
        </button>
    </form>
